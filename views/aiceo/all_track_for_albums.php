  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>All Tracks for Each Album</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">All Tracks for Each Album</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
?>
                <tr>
                    ...
                    <td><a href="/aiceo/all_tracks_detail/<?php echo $atracks->album_code?>?menu=sound_track&al_code=<?php echo $atracks->album_code?>&al_name=<?php echo $atracks->album_name;?>"><?php echo $atracks->album_code;?></a></td>
