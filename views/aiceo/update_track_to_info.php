...
$aic_base_url	= "/aiceo/";
$al_code = $this->input->get('al_code');
              ...
              <div class="card-body">
				...
				<div class="card card-primary">
				  ...
				  <form id="album_frm" method="POST" action="/aiceo/updateTrackSubmit" enctype="multipart/form-data">
					<input type="hidden" name="song_uno" value="<?php echo $single_tr[0]->track_uno;?>">
					<input type="hidden" name="album_code" value="<?php echo $al_code;?>">
					<input type="hidden" name="al_name" value="<?php echo $al_name;?>">
					<div class="card-body">
...
//-->
					  ...
					  <div class="form-group">
						...
						<input type="text" name="song_title"  value="<?php echo $single_tr[0]->track_title;?>"  id="slug-source" class="form-control" onkeyup="change();" required>
					  </div>					  
					  <div class="form-group">
						<label for="exampleInputPassword1">Title Slug <font color="#FF0000">*</font>{*:primary key}</label>
						<input type="text" name="song_slug" value="<?php echo $single_tr[0]->title_slug;?>"  class="form-control" id="slug-target" placeholder="101 Essential Opera Favourites by celebrated opera singers, Giacomo Puccini, Léo Delibes, Wolfgang Amadeus Mozart" readonly required>
					  </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
						...
						<input type="text" name="album_name" class="form-control" id="endTime"  placeholder="Album title" value="<?php echo $al_name;?>" disabled>
					  </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
						...
						<input type="text" name="genre_detail" class="form-control" id="exampleInputPassword1" placeholder="23451" value="<?php echo $single_tr[0]->genre_detail;?>" required>
					  </div>
					  <div class="form-group">
...
Gounod, Charles; 
Bizet, Georges; 
Ponchielli, Amilcare" required><?php echo $single_tr[0]->featured_musician;?></textarea>
					  </div>
...
Gounod, Charles; 
Bizet, Georges; 
Ponchielli, Amilcare" required><?php echo $single_tr[0]->composer;?></textarea>
					  </div>
        ...
        toolbar: [
          ...
          ['view', ['fullscreen', 'codeview', 'help']]
					...
					<div class="card-footer">
					  <button type="submit" id="form_submit" class="btn btn-primary">Save Song information</button>&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-primary" onclick="javascript:document.location.href='/aiceo/track_for_albums';">Cancel</button>
					</div>
