            ...
            <div class="card">
              ...
              <div class="card-body">
				...
				<div class="card card-primary">
				  <div class="card-header">
					<h3 class="card-title">Update Album Information</h3>
				  </div>
				  <!-- /.card-header action="javascript:alert( 'success!' );-->
				  <!-- form start -->
				  <!--<form id="formoid" action="" method="POST" enctype="multipart/form-data">-->
				  <form id="album_frm" method="POST" action="/aiceo/updateAlbumInformation" enctype="multipart/form-data">
					<input type="hidden" name="catalog_no" value="<?php echo $info->catalog_no;?>">
					<div class="card-body">
...
//-->
					  ...
					  <div class="form-group">
						...
						<input type="text" name="album_names" value="<?php echo $info->album_name?>" class="form-control"  id="slug-source" placeholder="101 Essential Opera Favourites - Welt Der Oper CD6" onkeyup="change();" required>
					  </div>
					  <div class="form-group">
						<label for="exampleInputEmail1">Title-Slug <font color="#FF0000">*</font></label>
						<input type="text" name="title_slug"  value="<?php echo $info->title_slug;?>"  id="slug-target" class="form-control"  readonly>
					  </div>					  
					  <div class="form-group">
						<label for="exampleInputPassword1">Album Summery(detail) <font color="#FF0000">*</font></label>
						<input type="text" name="album_ko_name" value="<?php echo $info->album_ko_name?>"  class="form-control" id="exampleInputPassword1" placeholder="101 Essential Opera Favourites by celebrated opera singers, Giacomo Puccini, Léo Delibes, Wolfgang Amadeus Mozart" required>
					  </div>
					  <div class="form-group">
						...
						<?php foreach ($big as $big_cate) :
								if ($info->genre == $big_cate->level1) { ?>
								<option value="<?php echo $big_cate->level1?>"  selected><?php echo $big_cate->level1?></option>
						<?php }else{ ?>
					  ...
					  <div class="form-group">
						...
						<?php foreach ($small as $small_cate) :
								if ($info->album_kinds == $small_cate->level2) { ?>
								<option value="<?php echo $small_cate->level2;?>" selected><?php echo $small_cate->level2;?></option>
						<?php }else{ ?>
					  ...
					  <div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text" value="<?php echo $info->sale_date;?>"  name="sale_date" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy" data-mask placeholder="yyyy" required>
						</div>						
					  </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
						...
						<input type="text" name="run_time" class="form-control" id="endTime"  placeholder="00:00:00" value="<?php echo $info->run_time;?>" required>
					  </div>
					  <div class="form-group">
...
Giuseppe Taddei, Italian Baritone" required><?php echo $info->artist_info;?></textarea>
					  </div>
					  <div class="form-group">
...
Gounod, Charles; 
Bizet, Georges; 
Ponchielli, Amilcare" required><?php echo $info->comp_info;?></textarea>
					  </div>
					  <div class="form-group">
						<label for="exampleInputPassword1">Recommandation Count <font color="#FF0000">*</font></label>
						<input type="text" name="recom" class="form-control" id="exampleInputPassword1" placeholder="23451" value="<?php echo $info->recom;?>" required>
					  </div>
					  <div class="form-group">
						<label for="exampleInputPassword1">Featured <font color="#FF0000">*</font></label>
                        <div class="form-check">
						<?php if ($info->featured !== 'yes') {?>
						...
						<?php }else{ ?>
						  ...
						  <label class="form-check-label">No</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input class="form-check-input" type="radio" name="featured" value="Yes" checked>
						  <label class="form-check-label">Yes</label>
						<?php } ?>
						</div>
					  </div>
					  <div class="form-group">
						...
						<?php   
								...
								case "Stereo ADD":
						?>
                          <input class="form-check-input" type="radio" name="record_method" value='Stereo DDD'>
						  <label class="form-check-label">Stereo DDD</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input class="form-check-input" type="radio" name="record_method" value='Stereo ADD' checked>
						  <label class="form-check-label">Stereo ADD</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input class="form-check-input" type="radio" name="record_method" value='Stereo AAD'>
						  <label class="form-check-label">Stereo AAD</label>
						<?php   
						...
						?>
                          ...
                          <input class="form-check-input" type="radio" name="record_method" value='Stereo ADD'>
						  <label class="form-check-label">Stereo ADD</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input class="form-check-input" type="radio" name="record_method" value='Stereo AAD' checked>
						  <label class="form-check-label">Stereo AAD</label>			  
						<?php   
								break;
						  }
					  ...
					  <div class="form-group">
						...
						<div class="input-group">
						  ...
						  <input type="text" name="album_price" class="form-control" value="<?php echo $info->album_price?>" placeholder="150.89" required>
						</div>
					  </div>
					  <div class="form-group">
						<label for="exampleInputPassword1">Album Type <font color="#FF0000">*</font></label>
                        <div class="form-check">
						<?php if ($info->album_quota == 'CD') {?>
                          <input class="form-check-input" type="radio" name="album_quota" value="CD" checked>
						  <label class="form-check-label">CD</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input class="form-check-input" type="radio" name="album_quota" value="DVD">
						...
						<?php }?>
						  <div class="col-2">
							Album quantity:<input type="text" name="quota_size" value="<?php echo $info->quota_size;?>" class="form-control">
						  </div>
						</div>
					  </div>
					  <!--<div class="form-group">
					  ...
					  <div class="form-group">
						...
						<img src="<?php echo $resources_url;?>ds/album_image/<?php echo $info->file_name1?>" width="80">
						<input type="hidden" name="old_front_image" value="<?php echo $info->file_name1;?>">
						<?php }?>
						<div class="input-group">
						  <div class="custom-file">
							<input type="file" name="front_image" class="custom-file-input">
					  ...
					  <div class="form-group">
						...
						<img src="<?php echo $resources_url;?>ds/album_image/<?php echo $info->file_name2?>" width="80">
						<input type="hidden" name="old_back_image" value="<?php echo $info->file_name2;?>">
						<?php }?>
						<div class="input-group">
						  <div class="custom-file">
							<input type="file" name="back_image" class="custom-file-input">
							<label class="custom-file-label" for="exampleInputFile">Choose file</label>
						  </div>
						</div>
...
<div class="form-group">
    ...
    <textarea id="summernote" name="description"><?php echo $info->description;?> </textarea>
    <script>
        ...
        toolbar: [
          ...
          ['view', ['fullscreen', 'codeview', 'help']]
					...
					<div class="card-footer">
					  <button type="submit" id="form_submit" class="btn btn-primary">Save Album</button>&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-primary" onclick="javascript:document.location.href='/aiceo/albums';">Cancel</button>
					</div>
