            ...
            <div class="under-hero container">
                ...
                <div class="section">
                    <div class="section__head">
                        <h3 class="mb-0">Featured <span class="text-primary">Composers</span></h3>
                    </div>
...
<?php
foreach ($featured_composers as $f_each_composer) {
    $f_given_name = $f_each_composer->first_name;
    $f_family_name = $f_each_composer->last_name;
    $f_full_name = $f_family_name.", ".$f_given_name;
    $f_link_name = $f_each_composer->url_slug;
    $f_birth_date = $f_each_composer->birth_date;
    $f_death_date = $f_each_composer->death_date;
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="avatar avatar--xxl d-block text-center scale-animation">
                                        <a href="artist-details.html" class="avatar__image mx-auto">
                                            <img src="<?php echo $resources_url.$f_each_composer->file_name1;?>" alt="Arebica Luna">
                                        </a>
...
?>                                                                
                ...
                <div class="section">
                    <div class="section__head">
                        <h3 class="mb-0">Top <span class="text-primary">Composers</span></h3>
                    </div>
                    ...
                    <div class="swiper-carousel swiper-carousel-button">
                        ...
                        <div class="swiper" data-swiper-slides="5" data-swiper-grid="true" data-swiper-autoplay="true">
                            <div class="swiper-wrapper">
<?php
foreach ($top_composers as $t_each_composer) {
    $t_given_name = $t_each_composer->first_name;
    $t_family_name = $t_each_composer->last_name;
                                    ...
                                    <a href="artist-details.html" class="cover cover--round scale-animation">
                                        <div class="cover__image">
                                            <div class="ratio ratio-1x1">
                                                <img src="<?php echo $resources_url.$t_each_composer->file_name1;?>" alt="">
                                            </div>
                                        </div>
