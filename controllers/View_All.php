...
//        log_message('debug', 'user initialize');
	...
	public function index()
	{
		try {
			...
			$topic['top_track_all_recordings'] = $this->topic_model->get_top_one_track_of_all();
			$this->load->view('view_all', $topic);
			$topic['song_detail_all'] = $this->topic_model->get_top_one_track_of_all();
			$this->load->view('player', $topic);
		} catch (Exception $e) {
